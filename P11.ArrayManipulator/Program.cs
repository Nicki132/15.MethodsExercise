...
namespace P11.ArrayManipulator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while ((command = Console.ReadLine()) != "end")
            {
                ...
                if (cmdType == "exchange")
                {
                    ...
                    numbers = ExchangeArraysParts(numbers, exchangeIndex);
                }
        ...
        static int[] ExchangeArraysParts(int[] numbers, int index)
        {
        ...
        // <summary>
        // Returns index of max element of given type. It returns -1 there are no matches.
        // </summary>
